...
<body>
  ...
  <header id="main-header">
   ...
   <!-- <div>
    ...
    <nav>
      <ul>
        <li><a class="mover" href="ayuda.html">Ayuda<i class="fa-solid fa-question"></i></a> </li><i class="fa-solid fa-grip-lines fa-rotate-90"></i>
        <li><a class="mover" href="carritocompras.html">Carrito de Compras</a> </li><i class="fa-solid fa-grip-lines fa-rotate-90"></i>
        <li><a href="CatalogoP.html">Catalogo</a></li>
      </ul>
      <a href="perfil.php" class="color1"  style= "color:black;"  ><i class="fas fa-user-circle"></i>Informción de Usuario</a> 
        <a href="cerrar-sesion.php"  class="color1" style="color:black;"><i class="fas fa-sign-out-alt"></i>Cerrar Sesión</a> 
    </nav>
<ul> 
</header>
